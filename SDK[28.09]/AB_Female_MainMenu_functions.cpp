...
class UClass* UAB_Female_MainMenu_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AB_Female_MainMenu_C");

	return Clss;
}


// AB_Female_MainMenu_C AB_Female_MainMenu.Default__AB_Female_MainMenu_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAB_Female_MainMenu_C* UAB_Female_MainMenu_C::GetDefaultObj()
{
	static class UAB_Female_MainMenu_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAB_Female_MainMenu_C*>(UAB_Female_MainMenu_C::StaticClass()->DefaultObject);
...
void UAB_Female_MainMenu_C::AnimGraph(struct FPoseLink* AnimGraph)
{
	...
	if (!Func)
		Func = Class->GetFunction("AB_Female_MainMenu_C", "AnimGraph");

	Params::UAB_Female_MainMenu_C_AnimGraph_Params Parms{};
...
void UAB_Female_MainMenu_C::BlueprintUpdateAnimation(float DeltaTimeX)
{
	...
	if (!Func)
		Func = Class->GetFunction("AB_Female_MainMenu_C", "BlueprintUpdateAnimation");

	Params::UAB_Female_MainMenu_C_BlueprintUpdateAnimation_Params Parms{};
