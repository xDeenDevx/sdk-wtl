namespace offsets
{
	namespace ADebugCameraController
	{
			...
			constexpr auto SelectedHitPoint = 0x590; // Size: 140, Type: struct FHitResult
			constexpr auto OriginalControllerRef = 0x620; // Size: 8, Type: struct APlayerController*
			constexpr auto OriginalPlayer = 0x628; // Size: 8, Type: struct UPlayer*
			constexpr auto SpeedScale = 0x630; // Size: 4, Type: float
			constexpr auto InitialMaxSpeed = 0x634; // Size: 4, Type: float
			constexpr auto InitialAccel = 0x638; // Size: 4, Type: float
			constexpr auto InitialDecel = 0x63c; // Size: 4, Type: float
	}
} 
