namespace offsets
{
	...
	{
			constexpr auto PhaseG = 0x40; // Size: 12, Type: struct FExpressionInput
			constexpr auto PhaseG2 = 0x54; // Size: 12, Type: struct FExpressionInput
			constexpr auto PhaseBlend = 0x68; // Size: 12, Type: struct FExpressionInput
			constexpr auto MultiScatteringContribution = 0x7c; // Size: 12, Type: struct FExpressionInput
			constexpr auto MultiScatteringOcclusion = 0x90; // Size: 12, Type: struct FExpressionInput
			constexpr auto MultiScatteringEccentricity = 0xa4; // Size: 12, Type: struct FExpressionInput
			constexpr auto ConservativeDensity = 0xb8; // Size: 12, Type: struct FExpressionInput
