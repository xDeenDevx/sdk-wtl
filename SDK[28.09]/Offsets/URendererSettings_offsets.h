namespace offsets
{
	namespace URendererSettings
	{
			...
			constexpr auto CustomDepthStencil = 0x88; // Size: 1, Type: enum class ECustomDepthStencil
			...
			constexpr auto MobilePlanarReflectionMode = 0xf0; // Size: 1, Type: enum class EMobilePlanarReflectionMode
			constexpr auto bStreamSkeletalMeshLODs = 0xf1; // Size: 1, Type: struct FPerPlatformBool
			constexpr auto bDiscardSkeletalMeshOptionalLODs = 0xf2; // Size: 1, Type: struct FPerPlatformBool
			constexpr auto VisualizeCalibrationColorMaterialPath = 0xf8; // Size: 24, Type: struct FSoftObjectPath
			constexpr auto VisualizeCalibrationCustomMaterialPath = 0x110; // Size: 24, Type: struct FSoftObjectPath
			constexpr auto VisualizeCalibrationGrayscaleMaterialPath = 0x128; // Size: 24, Type: struct FSoftObjectPath
	}
} 
