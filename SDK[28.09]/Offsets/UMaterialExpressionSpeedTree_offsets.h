namespace offsets
{
	...
	{
			constexpr auto GeometryInput = 0x40; // Size: 12, Type: struct FExpressionInput
			constexpr auto WindInput = 0x54; // Size: 12, Type: struct FExpressionInput
			constexpr auto LODInput = 0x68; // Size: 12, Type: struct FExpressionInput
			constexpr auto ExtraBendWS = 0x7c; // Size: 12, Type: struct FExpressionInput
