namespace offsets
{
	namespace UFoliageType
	{
			...
			constexpr auto BodyInstance = 0x158; // Size: 344, Type: struct FBodyInstance
			constexpr auto CustomNavigableGeometry = 0x2b0; // Size: 1, Type: enum class EHasCustomNavigableGeometry
			constexpr auto LightingChannels = 0x2b1; // Size: 1, Type: struct FLightingChannels
			constexpr auto bRenderCustomDepth = 0x2b4; // Size: 1, Type: char
			constexpr auto CustomDepthStencilWriteMask = 0x2b8; // Size: 1, Type: enum class ERendererStencilMask
			constexpr auto CustomDepthStencilValue = 0x2bc; // Size: 4, Type: int32_t
			constexpr auto TranslucencySortPriority = 0x2c0; // Size: 4, Type: int32_t
			constexpr auto CollisionRadius = 0x2c4; // Size: 4, Type: float
			constexpr auto ShadeRadius = 0x2c8; // Size: 4, Type: float
			constexpr auto NumSteps = 0x2cc; // Size: 4, Type: int32_t
			constexpr auto InitialSeedDensity = 0x2d0; // Size: 4, Type: float
			constexpr auto AverageSpreadDistance = 0x2d4; // Size: 4, Type: float
			constexpr auto SpreadVariance = 0x2d8; // Size: 4, Type: float
			constexpr auto SeedsPerStep = 0x2dc; // Size: 4, Type: int32_t
			constexpr auto DistributionSeed = 0x2e0; // Size: 4, Type: int32_t
			constexpr auto MaxInitialSeedOffset = 0x2e4; // Size: 4, Type: float
			constexpr auto bCanGrowInShade = 0x2e8; // Size: 1, Type: bool
			constexpr auto bSpawnsInShade = 0x2e9; // Size: 1, Type: bool
			constexpr auto MaxInitialAge = 0x2ec; // Size: 4, Type: float
			constexpr auto MaxAge = 0x2f0; // Size: 4, Type: float
			constexpr auto OverlapPriority = 0x2f4; // Size: 4, Type: float
			constexpr auto ProceduralScale = 0x2f8; // Size: 8, Type: struct FFloatInterval
			constexpr auto ScaleCurve = 0x300; // Size: 136, Type: struct FRuntimeFloatCurve
			constexpr auto ChangeCount = 0x388; // Size: 4, Type: int32_t
			constexpr auto ReapplyDensity = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyRadius = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyAlignToNormal = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyRandomYaw = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyScaling = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyScaleX = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyScaleY = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyScaleZ = 0x38c; // Size: 1, Type: char
			constexpr auto ReapplyRandomPitchAngle = 0x38d; // Size: 1, Type: char
			constexpr auto ReapplyGroundSlope = 0x38d; // Size: 1, Type: char
			constexpr auto ReapplyHeight = 0x38d; // Size: 1, Type: char
			constexpr auto ReapplyLandscapeLayers = 0x38d; // Size: 1, Type: char
			constexpr auto ReapplyZOffset = 0x38d; // Size: 1, Type: char
			constexpr auto ReapplyCollisionWithWorld = 0x38d; // Size: 1, Type: char
			constexpr auto ReapplyVertexColorMask = 0x38d; // Size: 1, Type: char
			constexpr auto bEnableDensityScaling = 0x38d; // Size: 1, Type: char
			constexpr auto bEnableDiscardOnLoad = 0x38e; // Size: 1, Type: char
			constexpr auto RuntimeVirtualTextures = 0x390; // Size: 16, Type: struct TArray<struct URuntimeVirtualTexture*>
			constexpr auto VirtualTextureCullMips = 0x3a0; // Size: 4, Type: int32_t
			constexpr auto VirtualTextureRenderPassType = 0x3a4; // Size: 1, Type: enum class ERuntimeVirtualTextureMainPassType
	}
} 
