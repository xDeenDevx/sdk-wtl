namespace offsets
{
	namespace UCameraAnim
	{
			...
			constexpr auto BasePostProcessSettings = 0x60; // Size: 1360, Type: struct FPostProcessSettings
			constexpr auto BasePostProcessBlendWeight = 0x5b0; // Size: 4, Type: float
	}
} 
