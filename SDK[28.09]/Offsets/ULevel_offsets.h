namespace offsets
{
	namespace ULevel
	{
			...
			constexpr auto AssetUserData = 0x268; // Size: 16, Type: struct TArray<struct UAssetUserData*>
			constexpr auto DestroyedReplicatedStaticActors = 0x288; // Size: 16, Type: struct TArray<struct FReplicatedStaticActorDestructionInfo>
	}
} 
