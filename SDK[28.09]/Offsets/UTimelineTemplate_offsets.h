namespace offsets
{
	namespace UTimelineTemplate
	{
			...
			constexpr auto VariableName = 0x90; // Size: 8, Type: struct FName
			constexpr auto DirectionPropertyName = 0x98; // Size: 8, Type: struct FName
			constexpr auto UpdateFunctionName = 0xa0; // Size: 8, Type: struct FName
			constexpr auto FinishedFunctionName = 0xa8; // Size: 8, Type: struct FName
	}
} 
