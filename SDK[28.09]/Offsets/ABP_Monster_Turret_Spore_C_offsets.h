namespace offsets
{
	namespace ABP_Monster_Turret_Spore_C
	{
			...
			constexpr auto MyWalker = 0xf38; // Size: 8, Type: struct AActor*
			constexpr auto myMonster = 0xf40; // Size: 8, Type: struct AWTLMonsterPawn*
			constexpr auto CurrentReloadTimeToSpawn = 0xf48; // Size: 4, Type: float
			constexpr auto IsOffsetZ = 0xf4c; // Size: 1, Type: bool
			constexpr auto TargetOffsetZ = 0xf50; // Size: 4, Type: float
			constexpr auto CurrentOffsetZ = 0xf54; // Size: 4, Type: float
	}
} 
