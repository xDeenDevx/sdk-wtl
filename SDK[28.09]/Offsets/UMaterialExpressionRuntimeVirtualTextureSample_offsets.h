namespace offsets
{
	...
	{
			constexpr auto Coordinates = 0x40; // Size: 12, Type: struct FExpressionInput
			constexpr auto WorldPosition = 0x54; // Size: 12, Type: struct FExpressionInput
			constexpr auto MipValue = 0x68; // Size: 12, Type: struct FExpressionInput
