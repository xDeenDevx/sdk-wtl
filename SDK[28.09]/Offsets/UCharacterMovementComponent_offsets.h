namespace offsets
{
	namespace UCharacterMovementComponent
	{
			...
			constexpr auto CurrentFloor = 0x2f0; // Size: 152, Type: struct FFindFloorResult
			constexpr auto DefaultLandMovementMode = 0x388; // Size: 1, Type: enum class EMovementMode
			constexpr auto DefaultWaterMovementMode = 0x389; // Size: 1, Type: enum class EMovementMode
			constexpr auto GroundMovementMode = 0x38a; // Size: 1, Type: enum class EMovementMode
			constexpr auto bMaintainHorizontalGroundVelocity = 0x38b; // Size: 1, Type: char
			constexpr auto bImpartBaseVelocityX = 0x38b; // Size: 1, Type: char
			constexpr auto bImpartBaseVelocityY = 0x38b; // Size: 1, Type: char
			constexpr auto bImpartBaseVelocityZ = 0x38b; // Size: 1, Type: char
			constexpr auto bImpartBaseAngularVelocity = 0x38b; // Size: 1, Type: char
			constexpr auto bJustTeleported = 0x38b; // Size: 1, Type: char
			constexpr auto bNetworkUpdateReceived = 0x38b; // Size: 1, Type: char
			constexpr auto bNetworkMovementModeChanged = 0x38b; // Size: 1, Type: char
			constexpr auto bIgnoreClientMovementErrorChecksAndCorrection = 0x38c; // Size: 1, Type: char
			constexpr auto bServerAcceptClientAuthoritativePosition = 0x38c; // Size: 1, Type: char
			constexpr auto bNotifyApex = 0x38c; // Size: 1, Type: char
			constexpr auto bCheatFlying = 0x38c; // Size: 1, Type: char
			constexpr auto bWantsToCrouch = 0x38c; // Size: 1, Type: char
			constexpr auto bCrouchMaintainsBaseLocation = 0x38c; // Size: 1, Type: char
			constexpr auto bIgnoreBaseRotation = 0x38c; // Size: 1, Type: char
			constexpr auto bFastAttachedMove = 0x38c; // Size: 1, Type: char
			constexpr auto bAlwaysCheckFloor = 0x38d; // Size: 1, Type: char
			constexpr auto bUseFlatBaseForFloorChecks = 0x38d; // Size: 1, Type: char
			constexpr auto bPerformingJumpOff = 0x38d; // Size: 1, Type: char
			constexpr auto bWantsToLeaveNavWalking = 0x38d; // Size: 1, Type: char
			constexpr auto bUseRVOAvoidance = 0x38d; // Size: 1, Type: char
			constexpr auto bRequestedMoveUseAcceleration = 0x38d; // Size: 1, Type: char
			constexpr auto bWasSimulatingRootMotion = 0x38d; // Size: 1, Type: char
			constexpr auto bAllowPhysicsRotationDuringAnimRootMotion = 0x38e; // Size: 1, Type: char
			constexpr auto bHasRequestedVelocity = 0x38e; // Size: 1, Type: char
			constexpr auto bRequestedMoveWithMaxSpeed = 0x38e; // Size: 1, Type: char
			constexpr auto bWasAvoidanceUpdated = 0x38e; // Size: 1, Type: char
			constexpr auto bProjectNavMeshWalking = 0x38e; // Size: 1, Type: char
			constexpr auto bProjectNavMeshOnBothWorldChannels = 0x38e; // Size: 1, Type: char
			constexpr auto AvoidanceConsiderationRadius = 0x3a0; // Size: 4, Type: float
			constexpr auto RequestedVelocity = 0x3a4; // Size: 12, Type: struct FVector
			constexpr auto AvoidanceUID = 0x3b0; // Size: 4, Type: int32_t
			constexpr auto AvoidanceGroup = 0x3b4; // Size: 4, Type: struct FNavAvoidanceMask
			constexpr auto GroupsToAvoid = 0x3b8; // Size: 4, Type: struct FNavAvoidanceMask
			constexpr auto GroupsToIgnore = 0x3bc; // Size: 4, Type: struct FNavAvoidanceMask
			constexpr auto AvoidanceWeight = 0x3c0; // Size: 4, Type: float
			constexpr auto PendingLaunchVelocity = 0x3c4; // Size: 12, Type: struct FVector
			constexpr auto NavMeshProjectionInterval = 0x474; // Size: 4, Type: float
			constexpr auto NavMeshProjectionTimer = 0x478; // Size: 4, Type: float
			constexpr auto NavMeshProjectionInterpSpeed = 0x47c; // Size: 4, Type: float
			constexpr auto NavMeshProjectionHeightScaleUp = 0x480; // Size: 4, Type: float
			constexpr auto NavMeshProjectionHeightScaleDown = 0x484; // Size: 4, Type: float
			constexpr auto NavWalkingFloorDistTolerance = 0x488; // Size: 4, Type: float
			constexpr auto PostPhysicsTickFunction = 0x490; // Size: 48, Type: struct FCharacterMovementComponentPostPhysicsTickFunction
			constexpr auto MinTimeBetweenTimeStampResets = 0x4d8; // Size: 4, Type: float
			constexpr auto CurrentRootMotion = 0x988; // Size: 56, Type: struct FRootMotionSourceGroup
			constexpr auto ServerCorrectionRootMotion = 0x9c0; // Size: 56, Type: struct FRootMotionSourceGroup
			constexpr auto RootMotionParams = 0xa90; // Size: 64, Type: struct FRootMotionMovementParams
			constexpr auto AnimRootMotionVelocity = 0xad0; // Size: 12, Type: struct FVector
	}
} 
