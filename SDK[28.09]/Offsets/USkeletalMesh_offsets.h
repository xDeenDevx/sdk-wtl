namespace offsets
{
	namespace USkeletalMesh
	{
			...
			constexpr auto MorphTargets = 0x188; // Size: 16, Type: struct TArray<struct UMorphTarget*>
			constexpr auto PostProcessAnimBlueprint = 0x310; // Size: 8, Type: UAnimInstance*
			constexpr auto MeshClothingAssets = 0x318; // Size: 16, Type: struct TArray<struct UClothingAssetBase*>
			constexpr auto SamplingInfo = 0x328; // Size: 48, Type: struct FSkeletalMeshSamplingInfo
			constexpr auto AssetUserData = 0x358; // Size: 16, Type: struct TArray<struct UAssetUserData*>
			constexpr auto Sockets = 0x368; // Size: 16, Type: struct TArray<struct USkeletalMeshSocket*>
			constexpr auto SkinWeightProfiles = 0x388; // Size: 16, Type: struct TArray<struct FSkinWeightProfileInfo>
	}
} 
