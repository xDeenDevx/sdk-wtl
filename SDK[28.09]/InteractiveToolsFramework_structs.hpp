...
{
public:
	uint8                                        Pad_1139[0xAC];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_113C[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_113D[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
