...
class UClass* ABP_Projectile_BubbleSplash_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Projectile_BubbleSplash_C");

	return Clss;
}


// BP_Projectile_BubbleSplash_C BP_Projectile_BubbleSplash.Default__BP_Projectile_BubbleSplash_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Projectile_BubbleSplash_C* ABP_Projectile_BubbleSplash_C::GetDefaultObj()
{
	static class ABP_Projectile_BubbleSplash_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Projectile_BubbleSplash_C*>(ABP_Projectile_BubbleSplash_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Projectile_BubbleSplash.BP_Projectile_BubbleSplash_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_Projectile_BubbleSplash_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Projectile_BubbleSplash_C", "ReceiveBeginPlay");
...
void ABP_Projectile_BubbleSplash_C::BndEvt__BP_Projectile_BubbleSplash_Sphere_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Projectile_BubbleSplash_C", "BndEvt__BP_Projectile_BubbleSplash_Sphere_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature");

	Params::ABP_Projectile_BubbleSplash_C_BndEvt__BP_Projectile_BubbleSplash_Sphere_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature_Params Parms{};
...
void ABP_Projectile_BubbleSplash_C::OnSplash(const struct FVector& SplashLocation)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Projectile_BubbleSplash_C", "OnSplash");

	Params::ABP_Projectile_BubbleSplash_C_OnSplash_Params Parms{};
