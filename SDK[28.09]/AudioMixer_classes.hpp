...
public:
	...
	uint8                                        Pad_CC[0x20];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_CE[0x28];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D2[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_22C[0x168];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_23C[0x78];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_253[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_26D[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C3[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
