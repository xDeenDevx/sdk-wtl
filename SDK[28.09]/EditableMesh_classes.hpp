...
public:
	...
	uint8                                        Pad_11F[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3BF[0x390];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3C1[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3C2[0x1E4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3F5[0xA4];                                     // Fixing Size Of Struct [ Dumper-7 ]
