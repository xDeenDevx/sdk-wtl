...
public:
	...
	uint8                                        Pad_B5[0x3C];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_BF[0x458];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C0[0x60];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F4[0x70];                                      // Fixing Size Of Struct [ Dumper-7 ]
