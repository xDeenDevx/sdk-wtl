...
class UFMODAudioComponent* UFMODBlueprintStatics::PlayEventAttachedWithParams(class UFMODEvent* Event, class USceneComponent* AttachToComponent, class FName AttachPointName, const struct FVector& Location, enum class EAttachLocation LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoPlay, TMap<class FName, float>& Params, bool bApplyOcclusion, bool bApplyOcclusionDirect)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FMODBlueprintStatics", "PlayEventAttachedWithParams");

	Params::UFMODBlueprintStatics_PlayEventAttachedWithParams_Params Parms{};
	...
	Parms.Params = Params;
	Parms.bApplyOcclusion = bApplyOcclusion;
	Parms.bApplyOcclusionDirect = bApplyOcclusionDirect;
...
class UFMODAudioComponent* UFMODBlueprintStatics::PlayEventAttached(class UFMODEvent* Event, class USceneComponent* AttachToComponent, class FName AttachPointName, const struct FVector& Location, enum class EAttachLocation LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoPlay)
{
	static class UFunction* Func = nullptr;
...
struct FFMODEventInstance UFMODBlueprintStatics::PlayEventAtLocationWithParams(class UObject* WorldContextObject, class UFMODEvent* Event, struct FTransform& Location, bool bAutoPlay, TMap<class FName, float>& Params, bool bApplyOcclusion, bool bApplyOcclusionDirect)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FMODBlueprintStatics", "PlayEventAtLocationWithParams");

	Params::UFMODBlueprintStatics_PlayEventAtLocationWithParams_Params Parms{};
...
struct FFMODEventInstance UFMODBlueprintStatics::PlayEvent2DWithParams(class UObject* WorldContextObject, class UFMODEvent* Event, bool bAutoPlay, TMap<class FName, float>& Params)
{
	...
	if (!Func)
		Func = Class->GetFunction("FMODBlueprintStatics", "PlayEvent2DWithParams");

	Params::UFMODBlueprintStatics_PlayEvent2DWithParams_Params Parms{};
...
void UFMODBlueprintStatics::EventInstanceTriggerCue(const struct FFMODEventInstance& EventInstance)
{
	...
	if (!Func)
		Func = Class->GetFunction("FMODBlueprintStatics", "EventInstanceTriggerCue");

	Params::UFMODBlueprintStatics_EventInstanceTriggerCue_Params Parms{};
