...
public:
	...
	uint8                                        Pad_42C[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	enum class EControlRigComponentSpace         Space;                                             // 0x40(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_438[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_440[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	enum class EControlRigComponentSpace         Space;                                             // 0x40(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_447[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
